  ...
  resources: {
    uk: {
      translation: {
        ...
        bet_placed: "Ставка зроблена на матч {{home}} - {{away}}",
        ...
        support_unavailable: "Служба підтримки тимчасово недоступна. Спробуйте пізніше.",
        hello: "Привіт! Як можемо допомогти?",
        replenish_info: "Для поповнення балансу натисніть кнопку 'Поповнити демо баланс'.",
        casino_info: "Казино працює в демо-режимі. Спробуйте слот-машину або рулетку!",
        match_info: "Live-матчі оновлюються кожні 2 хвилини. Виберіть вид спорту для фільтрації."
      }
    },
    en: {
      translation: {
        ...
        bet_placed: "Bet placed on match {{home}} - {{away}}",
        win: "Win! +{{amount}} UAH 🎉",
        try_again: "Try again!",
        ...
        replenish_info: "To top up your balance, click the 'Top Up Demo Balance' button.",
        casino_info: "Casino is in demo mode. Try the slot machine or roulette!",
        match_info: "Live matches update every 2 minutes. Select a sport to filter."
      }
    }
  }
}, () => {
...
async function fetchMatches(sportId = 'all') {
  ...
  console.log(`Fetching matches for sportId: ${sportId}`);
  try {
